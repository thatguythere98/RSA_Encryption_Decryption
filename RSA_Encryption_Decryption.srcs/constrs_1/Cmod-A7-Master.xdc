...
#Below are Fredy settings
## 12 MHz Clock Signal
#set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L12P_T1_MRCC_14 Sch=gclk
#create_clock -add -name sys_clk_pin -period 83.33 -waveform {0 41.66} [get_ports { clk }];

#clock constraints for generated clock
#create_generated_clock -name clk_out1 -source [get_ports clk] [get_pins clock_wizard/clk_out1]

## Reset Button
#set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { rst }]; # Assigns the reset button to your design, #IO_L19N_T3_VREF_16 Sch=btn[0]

## UART TX and RX Pins
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { tx }]; # Maps UART TX to FPGA pin J18
#set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { rx }]; # Maps UART RX to FPGA pin J17
#Above are Fredy settings


#test for modules 
#set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { clk }];
#create_clock -add -name sys_clk_pin -period 135.578 -waveform {0 67.789} [get_ports { clk }];
#set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { rst }];
#test for modules



#Below are default cmod a7 signals
## 12 MHz Clock Signal
