...
always  @ (proj2_tb.dut.proj2.current_state) begin 
$display("%0t Current State =  %d \n",$time ,proj2_tb.dut.proj2.current_state);
end
 	...
 	reg  [1:0]  current_state, next_state;
  	...
  	always @(*) begin
    	...
    	case (current_state)
      		...
      		2'd1: begin //subtraction
	  			O = temp_O;

	  			if(temp_O < in_A) begin
				next_state = 2'd0;
				Done = 1;
				end
				else begin
	...
	reg [7:0] expC;
  	...
  	always @(*) begin
    	...
    	case (current_state)
      		...
      		3'd1: begin 
	  			next_state = 3'd2;
	  			if (in_A_temp[C]) shift_in = in_A;
	  			else add_y = 0;
			end

      		3'd2: begin
	  			//O = temp_O;
          		if (C == 3'd7) next_state = 3'd3;
      		...
      		3'd3: begin
	  			//next_state = 3'd0;
	  			//Done = 1;
			if(expC == (in_B-8'd2)) next_state = 3'd4;
			else next_state = 3'd1;
		end
